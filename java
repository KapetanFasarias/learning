                ...
                try {
                    ...
                    if (userInput > 0 && userInput <= 100) {
                        if (userInput < randomNumber) {
                            System.out.println(userInput + " είναι χαμηλό. Έχεις αλλες " + (10 - tryCounter) + " Απόπειρες. Ξαναπροσπάθησε!");
                        } else if (userInput > randomNumber) {
                            System.out.println(userInput + " είναι υψηλό. Έχεις αλλες " + (10 - tryCounter) + " Απόπειρες.  Ξαναπροσπάθησε!");
                        } else {
                        ...
                        System.out.println("Ο αριθμός που δώσατε δεν βρίσκεται στο εύρος 1-100.\n Προασπαθήστε ξανά");
                } catch (Exception e) {
                    System.out.println("Δεν ηταν εγκυρη η εισαγωγή σας.");
                }
            }
            if (tryCounter < 10 && playAgain == false) break;
            if (tryCounter == 10) {
